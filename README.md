...
- Bonificaciones/deducciones como líneas independientes y validadas para asegurar importes coherentes.
- Declaraciones de renta anuales con máximo de 14 nóminas del mismo año natural y del mismo empleado.
- Vistas listas/formularios con barras de estado y contadores para hacer los datos fácilmente accesibles.

Dependencias: `base` y `hr`.
